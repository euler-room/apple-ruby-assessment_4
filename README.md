...
- The NationWeatherService class (`app/services/national_weathe_service.rb`) uses the National Weather Service for forecast data ([api.weather.gov](https://api.weather.gov/gridpoints/OTX/149,57/forecast))
